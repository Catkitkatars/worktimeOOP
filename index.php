...
class OrderCounter {
    ...
    {   
        if($this->orderDate->format('N') >= 6) {
            $this->orderDate->add(new DateInterval($this->skipDays()));
...
$cases = [
    ...
    'ранняя пташка' => [['2023.05.15 09:00:00', [10, 19]], '2023.05.17 16:00:00'], // 
    'супер пунктуальность' => [['2023.05.15 10:00:00', [10, 19]], '2023.05.17 16:00:00'], // 
